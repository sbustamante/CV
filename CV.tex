...
\cvitem{\small\textbf{2013}}							
	...
	Colombia.}
\cvitem{\small\textbf{GPA}}
	{\textit{4.36} (grades range linearly from 0.0 to 5.0. The minimum passing grade is 3.0).} 	
...
\cvitem{\small\textbf{2015 (Dec)}}
	{\textbf{Master in Physics}, \textit{Physics Institute, Universidad de Antioquia}, Medellín, 
	Colombia.}
\cvitem{\small\textbf{Thesis}}
	{``Verying the Voronoi-Particle-Hydrodynamics (VPH) scheme for Galaxy Formation''.}
\cvitem{\small\textbf{Advisor}}
	{Juan Carlos Munoz-Cuartas, Ph.D.}
...
\cvitem{\small\textbf{Development}}
	{C/C++, Python, Basic, TI Basic, bash.}
...
\cvitem{\small\textbf{ Prof.}}
	...
	Universidad de Antioquia}, Medellín, Colombia.}
\cvitem{\small\textbf{ Prof.}}
	{\textbf{Computational Methods for Astronomers, 2014/II}, \textit{Faculty of Exact and Natural 
