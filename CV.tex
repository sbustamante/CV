...
\AfterPreamble{\hypersetup{
  ...
  pdftitle={CV Sebastian Bustamante},
  urlcolor=blue,
}}
...
\cvitem{\small\textbf{2001-2006}}							
	{\textbf{High School.}} 
\cvitem{\small\textbf{}}
	{Institución Educativa Cisneros, Colombia.} 	
...
\cvitem{}
	...
	\end{itemize}
	\item \textbf{Programming languages:} Python, C, C++, Bash, Mathematica, TI-Basic.
	\item \textbf{Systems and Software:} Linux, MSWindows, LaTeX, gnuplot, git.
...
\cvitem{}
	{I am the main scientific advisor of Daniel Montenegro. He is an undergraduate student of Astronomy at Universidad de Antioquia, in Colombia.}
...
\cvitem{}
	{\href{mailto:msparre@aip.de }{\texttt{msparre@aip.de }}}
\cvitem{}
